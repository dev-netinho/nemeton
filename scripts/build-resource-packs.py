...
ITEMS = {
    "root_essence": {"java_parent": "minecraft:item/generated", "bedrock_icon": "nemeton_root_essence", "base": "minecraft:amethyst_shard", "cmd": 7101},
    "root_blade": {"java_parent": "minecraft:item/handheld", "bedrock_icon": "nemeton_root_blade", "base": "minecraft:diamond_sword", "cmd": 7102},
    "warden_axe": {"java_parent": "minecraft:item/handheld", "bedrock_icon": "nemeton_warden_axe", "base": "minecraft:diamond_axe", "cmd": 7103},
    "sentinel_chestplate": {"java_parent": "minecraft:item/generated", "bedrock_icon": "nemeton_sentinel_chestplate", "base": "minecraft:diamond_chestplate", "cmd": 7104},
    "abyss_heart": {"java_parent": "minecraft:item/generated", "bedrock_icon": "nemeton_abyss_heart", "base": "minecraft:nether_star", "cmd": 7105},
    "end_heart": {"java_parent": "minecraft:item/generated", "bedrock_icon": "nemeton_end_heart", "base": "minecraft:dragon_breath", "cmd": 7106},
    "backpack": {"java_parent": "minecraft:item/generated", "bedrock_icon": "nemeton_backpack", "base": "minecraft:bundle", "cmd": 7110},
}
...
def build_java() -> None:
    ensure_clean(JAVA)
    write_json(JAVA / "pack.mcmeta", {"pack": {"pack_format": 75, "description": "Nemeton Visual Pack — Vanilla+ crossplay"}})
...
def build_bedrock() -> None:
    ...
    write_json(BEDROCK / "manifest.json", {
        "format_version": 2,
        "header": {
            "name": "Nemeton Visual Pack",
            "description": "Texturas Vanilla+ equivalentes para Bedrock via Geyser.",
            "uuid": "3fc3c31f-1b33-4f85-bd67-ff27bf99e8c4",
            "version": [1, 0, 0],
            "min_engine_version": [1, 21, 0]
        },
        "modules": [{
            "type": "resources",
            "uuid": "4e173179-f3f1-4e59-8336-ad0ddb2dc54b",
            "version": [1, 0, 0]
        }]
    })
    texture_data = {}
...
def main() -> None:
    ...
    java_hash = zip_dir(JAVA, DIST / "Nemeton-Java.zip")
    zip_dir(BEDROCK, DIST / "Nemeton-Bedrock.mcpack")
